...
public class GameHtmlParserTest {
    ...
    public void extractGameCategories() {
        ...
        assertEquals("https://www.speedrun.com/ajax_leaderboard.php?game=sm64&category=2409&verified=1&variable5138=16457&loadtimes=0&emulator=2", fullGame.getCategories().get(0).getId());

        assertEquals("70 Star", fullGame.getCategories().get(1).getName());
        assertEquals("https://www.speedrun.com/ajax_leaderboard.php?game=sm64&category=2410&verified=1&variable5138=16457&loadtimes=0&emulator=2", fullGame.getCategories().get(1).getId());

        assertEquals("16 Star", fullGame.getCategories().get(2).getName());
        assertEquals("https://www.speedrun.com/ajax_leaderboard.php?game=sm64&category=2414&verified=1&variable5138=16457&loadtimes=0&emulator=2", fullGame.getCategories().get(2).getId());

        assertEquals("1 Star", fullGame.getCategories().get(3).getName());
        assertEquals("https://www.speedrun.com/ajax_leaderboard.php?game=sm64&category=2415&verified=1&variable5138=16457&loadtimes=0&emulator=2", fullGame.getCategories().get(3).getId());

        assertEquals("0 Star", fullGame.getCategories().get(4).getName());
        assertEquals("https://www.speedrun.com/ajax_leaderboard.php?game=sm64&category=2416&verified=1&variable5138=16457&loadtimes=0&emulator=2", fullGame.getCategories().get(4).getId());
    }
